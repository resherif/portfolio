      ...
      <div className="max-w-4xl mx-auto text-center">
        ...
        <div className="grid sm:grid-cols-3 gap-6 ">
          ...
          <a href="mailto:rehamsherrif@gmail.com" 
             className="group p-8 border border-indigo-400 rounded-2xl  transition-all duration-300">
            <Mail className="mx-auto mb-4 text-indigo-400 group-hover:text-indigo-600" size={32} />
          ...
          <a href={`https://wa.me/${phone}`} 
             ...
             className="group p-8 border border-indigo-400 rounded-2xl  transition-all duration-300">
            <MessageCircle className="mx-auto mb-4 text-indigo-400 group-hover:text-indigo-600" size={32} />
          ...
          <a href="https://www.linkedin.com/in/reham-sherif-a6b631216" 
             target="_blank" rel="noreferrer"
             className="group p-8 border border-indigo-400 rounded-2xl  transition-all duration-300">
            <FaLinkedin className="mx-auto mb-4 text-indigo-400 group-hover:text-indigo-600" size={32} />
